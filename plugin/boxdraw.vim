...
" 2004-06-30 -- do not use shift+arrows unless in win32_xx
...
fu! <SID>S()
  ...
  en
  vnoremap <buffer> <Leader>a :ToAscii<cr>
...
fu! Introduce_boxdraw()
    :nmap <buffer> ,b :call <SID>S()<CR>
endf
"all Introduce_boxdraw()
 
if has("win32_xx")
  " Under win32_xx activate boxdrwaing mode upon start.
