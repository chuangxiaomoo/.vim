...
" actually they use <LocalLeader> (:he mapleader), so the user can
...
"et maplocalleader  = g:C_MapLeader
let maplocalleader  = '\'
if !hasmapto('<Plug>AM_a?')   |map <unique> <LocalLeader>a?		<Plug>AM_a?|endif
if !hasmapto('<Plug>AM_a,')   |map <unique> <LocalLeader>a,		<Plug>AM_a,|endif
if !hasmapto('<Plug>AM_a<')   |map <unique> <LocalLeader>a<		<Plug>AM_a<|endif
if !hasmapto('<Plug>AM_a=')   |map <unique> <LocalLeader>a=		<Plug>AM_a=|endif
if !hasmapto('<Plug>AM_a(')   |map <unique> <LocalLeader>a(		<Plug>AM_a(|endif
if !hasmapto('<Plug>AM_abox') |map <unique> <LocalLeader>abox	<Plug>AM_abox|endif
if !hasmapto('<Plug>AM_acom') |map <unique> <LocalLeader>acom	<Plug>AM_acom|endif
if !hasmapto('<Plug>AM_adcom')|map <unique> <LocalLeader>adcom	<Plug>AM_adcom|endif
if !hasmapto('<Plug>AM_aocom')|map <unique> <LocalLeader>aocom	<Plug>AM_aocom|endif
if !hasmapto('<Plug>AM_ascom')|map <unique> <LocalLeader>ascom	<Plug>AM_ascom|endif
if !hasmapto('<Plug>AM_adec') |map <unique> <LocalLeader>adec	<Plug>AM_adec|endif
if !hasmapto('<Plug>AM_adef') |map <unique> <LocalLeader>adef	<Plug>AM_adef|endif
if !hasmapto('<Plug>AM_afnc') |map <unique> <LocalLeader>afnc	<Plug>AM_afnc|endif
if !hasmapto('<Plug>AM_afnc') |map <unique> <LocalLeader>afnc	<Plug>AM_afnc|endif

" Number alignment maps: {{{2
if !hasmapto('<Plug>AM_aunum')|map <unique> <LocalLeader>aunum	<Plug>AM_aunum|endif
if !hasmapto('<Plug>AM_aenum')|map <unique> <LocalLeader>aenum	<Plug>AM_aenum|endif
if exists("g:alignmaps_euronumber") && !exists("g:alignmaps_usanumber")
 if !hasmapto('<Plug>AM_anum')|map <unique> <LocalLeader>anum	<Plug>AM_aenum|endif
else
 if !hasmapto('<Plug>AM_anum')|map <unique> <LocalLeader>anum	<Plug>AM_aunum|endif
endif
...
if !hasmapto('<Plug>AM_Htd')|map <unique> <LocalLeader>Htd	<Plug>AM_Htd|endif
...
if !hasmapto('<Plug>AM_T|')|map <unique> <LocalLeader>T|		<Plug>AM_T||endif
if !hasmapto('<Plug>AM_T#')	 |map <unique> <LocalLeader>T#		<Plug>AM_T#|endif
if !hasmapto('<Plug>AM_T,')	 |map <unique> <LocalLeader>T,		<Plug>AM_T,o|endif
if !hasmapto('<Plug>AM_Ts,') |map <unique> <LocalLeader>Ts,		<Plug>AM_Ts,|endif
if !hasmapto('<Plug>AM_T:')	 |map <unique> <LocalLeader>T:		<Plug>AM_T:|endif
if !hasmapto('<Plug>AM_T;')	 |map <unique> <LocalLeader>T;		<Plug>AM_T;|endif
if !hasmapto('<Plug>AM_T<')	 |map <unique> <LocalLeader>T<		<Plug>AM_T<|endif
if !hasmapto('<Plug>AM_T=')	 |map <unique> <LocalLeader>T=		<Plug>AM_T=|endif
if !hasmapto('<Plug>AM_T?')	 |map <unique> <LocalLeader>T?		<Plug>AM_T?|endif
if !hasmapto('<Plug>AM_T@')	 |map <unique> <LocalLeader>T@		<Plug>AM_T@|endif
if !hasmapto('<Plug>AM_TW@') |map <unique> <LocalLeader>TW@		<Plug>AM_TW@|endif
if !hasmapto('<Plug>AM_Tab') |map <unique> <LocalLeader>Tab		<Plug>AM_Tab|endif
if !hasmapto('<Plug>AM_Tsp') |map <unique> <LocalLeader>Tsp		<Plug>AM_Tsp|endif
if !hasmapto('<Plug>AM_T~')	 |map <unique> <LocalLeader>T~		<Plug>AM_T~|endif
...
if !hasmapto('<Plug>AM_ts<')	|map <unique> <LocalLeader>ts<	<Plug>AM_ts<|endif
if !hasmapto('<Plug>AM_ts=')	|map <unique> <LocalLeader>ts=	<Plug>AM_ts=|endif
if !hasmapto('<Plug>AM_w=')		|map <unique> <LocalLeader>w=	<Plug>AM_w=|endif
if !hasmapto('<Plug>AM_t?')		|map <unique> <LocalLeader>t?	<Plug>AM_t?|endif
if !hasmapto('<Plug>AM_t~')		|map <unique> <LocalLeader>t~	<Plug>AM_t~|endif
if !hasmapto('<Plug>AM_t@')		|map <unique> <LocalLeader>t@	<Plug>AM_t@|endif
if !hasmapto('<Plug>AM_tW@')	|map <unique> <LocalLeader>tW@	<Plug>AM_tW@|endif
if !hasmapto('<Plug>AM_m=')		|map <unique> <LocalLeader>m=	<Plug>AM_m=|endif
if !hasmapto('<Plug>AM_tab')	|map <unique> <LocalLeader>tab	<Plug>AM_tab|endif
if !hasmapto('<Plug>AM_tml')	|map <unique> <LocalLeader>tml	<Plug>AM_tml|endif
if !hasmapto('<Plug>AM_tsp')	|map <unique> <LocalLeader>tsp	<Plug>AM_tsp|endif
if !hasmapto('<Plug>AM_tsq')	|map <unique> <LocalLeader>tsq	<Plug>AM_tsq|endif
if !hasmapto('<Plug>AM_tt')		|map <unique> <LocalLeader>tt	<Plug>AM_tt|endif
...
if has("menu") && has("gui_running") && &go =~# 'm' && !exists("s:firstmenu")
 ...
 if g:DrChipTopLvlMenu != ""
  ...
  exe 'menu '.g:DrChipTopLvlMenu.'AlignMaps.Numbers\ (American-Style)<tab>'.s:emapleader.'aunum	<LocalLeader>aunum	'.s:mapleader.'aunum	<LocalLeader>aunum'
