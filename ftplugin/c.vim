...
" 
" ------- statements menu:  /root/.vim/c-support/templates/c.statements.template ---- 
"
 noremap  <buffer>  <silent>  <LocalLeader>xd           :call C_InsertTemplate("statements.xt_dbg")<CR>
inoremap  <buffer>  <silent>  <LocalLeader>xd      <Esc>:call C_InsertTemplate("statements.xt_dbg")<CR>
 noremap  <buffer>  <silent>  <LocalLeader>xp           :call C_InsertTemplate("statements.xt_pri")<CR>
inoremap  <buffer>  <silent>  <LocalLeader>xp      <Esc>:call C_InsertTemplate("statements.xt_pri")<CR>
 noremap  <buffer>  <silent>  <LocalLeader>xr           :call C_InsertTemplate("statements.xt_ret")<CR>
inoremap  <buffer>  <silent>  <LocalLeader>xr      <Esc>:call C_InsertTemplate("statements.xt_ret")<CR>
 noremap  <buffer>  <silent>  <LocalLeader>xg           :call C_InsertTemplate("statements.xt_goto")<CR>
inoremap  <buffer>  <silent>  <LocalLeader>xg      <Esc>:call C_InsertTemplate("statements.xt_goto")<CR>

 noremap  <buffer>  <silent>  <LocalLeader>sr           :call C_InsertTemplate("statements.return_val_if_fail")<CR>
inoremap  <buffer>  <silent>  <LocalLeader>sr      <Esc>:call C_InsertTemplate("statements.return_val_if_fail")<CR>
 noremap  <buffer>  <silent>  <LocalLeader>sv           :call C_InsertTemplate("statements.return_if_fail")<CR>
...
inoremap    <buffer>  <silent>  <LocalLeader>sif   <Esc>:call C_InsertTemplate("statements.if-block")<CR>
 ...
 noremap    <buffer>  <silent>  <LocalLeader>sie       :call C_InsertTemplate("statements.if-block-else")<CR>
vnoremap    <buffer>  <silent>  <LocalLeader>sie  <Esc>:call C_InsertTemplate("statements.if-block-else", "v")<CR>
inoremap    <buffer>  <silent>  <LocalLeader>sie  <Esc>:call C_InsertTemplate("statements.if-block-else")<CR>
...
vnoremap    <buffer>  <silent>  <LocalLeader>sw    <Esc>:call C_InsertTemplate("statements.while", "v")<CR>
