...
" ---------- statement menu ----------------------------------------------------
"
 noremap  <buffer>  <silent>  <LocalLeader>sh           :call BASH_InsertTemplate("statements.here")<CR>
inoremap  <buffer>  <silent>  <LocalLeader>sh      <Esc>:call BASH_InsertTemplate("statements.here")<CR>

 noremap  <buffer>  <silent>  <LocalLeader>sr           :call BASH_InsertTemplate("statements.xt_ret")<CR>
inoremap  <buffer>  <silent>  <LocalLeader>sr      <Esc>:call BASH_InsertTemplate("statements.xt_ret")<CR>

 noremap  <buffer>  <silent>  <LocalLeader>st           :call BASH_InsertTemplate("statements.test")<CR>
inoremap  <buffer>  <silent>  <LocalLeader>st      <Esc>:call BASH_InsertTemplate("statements.test")<CR>

 noremap  <buffer>  <silent>  <LocalLeader>sx           :call BASH_InsertTemplate("statements.xert")<CR>
inoremap  <buffer>  <silent>  <LocalLeader>sx      <Esc>:call BASH_InsertTemplate("statements.xert")<CR>
...
" -- self define end --
 ...
 noremap  <buffer>  <silent>  <LocalLeader>sfi          :call BASH_InsertTemplate("statements.for-in")<CR>
 noremap  <buffer>  <silent>  <LocalLeader>sfo          :call BASH_InsertTemplate("statements.for")<CR>
 noremap  <buffer>  <silent>  <LocalLeader>sif          :call BASH_InsertTemplate("statements.if")<CR>
...
inoremap  <buffer>  <silent>  <LocalLeader>sfi     <Esc>:call BASH_InsertTemplate("statements.for-in")<CR>
inoremap  <buffer>  <silent>  <LocalLeader>sfo     <Esc>:call BASH_InsertTemplate("statements.for")<CR>
inoremap  <buffer>  <silent>  <LocalLeader>sif     <Esc>:call BASH_InsertTemplate("statements.if")<CR>
...
vnoremap  <buffer>  <silent>  <LocalLeader>sfi     <Esc>:call BASH_InsertTemplate("statements.for-in", "v")<CR>
vnoremap  <buffer>  <silent>  <LocalLeader>sfo     <Esc>:call BASH_InsertTemplate("statements.for", "v")<CR>
vnoremap  <buffer>  <silent>  <LocalLeader>sif     <Esc>:call BASH_InsertTemplate("statements.if", "v")<CR>
...
vnoremap  <buffer>  <silent>  <LocalLeader>sfu     <Esc>:call BASH_InsertTemplate("statements.function", "v")<CR>
 ...
 noremap  <buffer>  <silent>  <LocalLeader>sfm          :call BASH_InsertTemplate("statements.mfunction")<CR>
inoremap  <buffer>  <silent>  <LocalLeader>sfm     <Esc>:call BASH_InsertTemplate("statements.mfunction")<CR>
vnoremap  <buffer>  <silent>  <LocalLeader>sfm     <Esc>:call BASH_InsertTemplate("statements.mfunction", "v")<CR>
...
vnoremap  <buffer>  <silent>  <LocalLeader>sp      <Esc>:call BASH_InsertTemplate("statements.printf", "v")<CR>
 ...
 noremap  <buffer>  <silent>  <LocalLeader>sec          :call BASH_InsertTemplate("statements.echo")<CR>
inoremap  <buffer>  <silent>  <LocalLeader>sec     <Esc>:call BASH_InsertTemplate("statements.echo")<CR>
vnoremap  <buffer>  <silent>  <LocalLeader>sec     <Esc>:call BASH_InsertTemplate("statements.echo", "v")<CR>
